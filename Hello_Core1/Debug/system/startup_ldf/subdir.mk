...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="Hello_Core1" -proc ADSP-SC589 -si-revision any -g -DCORE1 -D_DEBUG -DADI_MCAPI @includes-d8e21672c4abbcfbb8a59fb9315fe762.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="Hello_Core1" -proc ADSP-SC589 -si-revision any -g -DCORE1 -D_DEBUG -DADI_MCAPI @includes-d8e21672c4abbcfbb8a59fb9315fe762.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
